...
//     version 1.3.0
//     from Assets/A1/DiscoInputActions.inputactions
//
...
public partial class @DiscoInputActions : IInputActionCollection2, IDisposable
{
    ...
    ""maps"": [
        {
            ...
            ""actions"": [
                ...
                },
                {
                    ""name"": ""CheatCode"",
                    ""type"": ""Button"",
                    ""id"": ""075d1cac-028e-4d89-9f14-d9a8ed889a1e"",
                    ""expectedControlType"": ""Button"",
                    ""processors"": """",
                    ""interactions"": """",
                    ""initialStateCheck"": false
            ...
            ""bindings"": [
                ...
                {
                    ""name"": """",
                    ""id"": ""6237e63d-6df9-4f2a-8fd8-2aa333f2600e"",
    ...
    ""controlSchemes"": []
        ...
        m_DiscoInputMap_CheatCode = m_DiscoInputMap.FindAction("CheatCode", throwIfNotFound: true);
    }
    ...
    private readonly InputAction m_DiscoInputMap_CheatCode;
    public struct DiscoInputMapActions
    {
        ...
        public InputAction @CheatCode => m_Wrapper.m_DiscoInputMap_CheatCode;
        ...
        public void SetCallbacks(IDiscoInputMapActions instance)
        {
            if (m_Wrapper.m_DiscoInputMapActionsCallbackInterface != null)
            {
                ...
                @CheatCode.started -= m_Wrapper.m_DiscoInputMapActionsCallbackInterface.OnCheatCode;
                @CheatCode.performed -= m_Wrapper.m_DiscoInputMapActionsCallbackInterface.OnCheatCode;
                @CheatCode.canceled -= m_Wrapper.m_DiscoInputMapActionsCallbackInterface.OnCheatCode;
            }
